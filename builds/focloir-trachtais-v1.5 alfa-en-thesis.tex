...
\subsubsection*{0-shot (ainmfhocal): 0-sonra}
...
\begin{itemize}
	...
	\item Tá an téarma `comhiomlán' ar Tearma.ie, gan trácht ar an bhfocal `tionól'. Ní ghlactar leis sin toisc nach n-aontaíonn sé lena bhfuil ar fáil sna foclóirí dúchasacha. 
\end{itemize}
...
\subsubsection*{few-shot (ainmfhocal): cúpla-sonra}
...
\subsubsection*{linear (aidiacht): líneach}
 \noindent \textit{Sainmhíniú (ga):} I gcomthéacs matamaitice, comhairthe mar shuim ualaithe de roinnt athróga; m.sh. y = aX1 + bX2 ... + kXn.
\\
 \noindent \textit{Sainmhíniú (en):} In the context of mathematics, calculated as a weighted some of various variables; for example, y = aX1 + bX2 ... + kXn.
\\
 \noindent \textit{Tagairtí:}
\begin{itemize}
