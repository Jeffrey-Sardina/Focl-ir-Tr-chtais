...
Tá na téarmaí uilig sa bhFoclóir Tráchtais, leagan 1.7 \cite{focloir-trachtais}, le feiceáil thíos.
...
\begin{longtable}{|l|l|}
	\hline
		...
		eanga (ST)&language model (LM)\\ \hline 
		...
		samhail teanga mhór (STM)&large language model (LLM)\\ \hline 
...
\subsubsection*{eanga (ST) (ainmfhocal): language model (LM)}
...
\subsubsection*{samhail teanga mhór (STM) (ainmfhocal): large language model (LLM)}
