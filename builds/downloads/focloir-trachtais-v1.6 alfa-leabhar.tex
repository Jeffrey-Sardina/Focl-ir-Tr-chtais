...
\subsubsection*{ablation experiment: turgnamh ionadaithe}
ainmfhocal
...
\subsubsection*{to abstract: teibigh}
ainmfhocal
...
\subsubsection*{abstraction: teibiú}
ainmfhocal
...
\subsubsection*{activation function: feidhm ghníomhachtaithe}
ainmfhocal
...
\subsubsection*{adjacency matrix: maitrís chóngarachta}
ainmfhocal
...
\subsubsection*{aggregate: tionól}
ainmfhocal
...
\subsubsection*{algorithm: algartam}
ainmfhocal
...
\subsubsection*{alignment: ailíniú}
ainmfhocal
...
\subsubsection*{antecedent: réamhthéarma}
ainmfhocal
...
\subsubsection*{application (in practice): úsáid (phraiticiúil)}
ainmfhocal
...
\subsubsection*{application domain: réimse úsáide}
ainmfhocal
...
\subsubsection*{to approximate: meastachán a dhéanamh (ar)}
ainmfhocal
...
\subsubsection*{approximation: meastachán}
ainmfhocal
...
\subsubsection*{arbitrary: treallach}
aidiacht
...
\subsubsection*{architecture: dearadh}
ainmfhocal
...
\subsubsection*{artificial intelligence (AI) (concept): intleacht shaorga (IS) (coincheap)}
ainmfhocal
...
\subsubsection*{artificial intelligence (AI) (system): córas intleachta saorga (córas IS)}
ainmfhocal
...
\subsubsection*{assumption: foshuíomh}
ainmfhocal
...
\subsubsection*{to attend to: aird a thabhairt ar}
ainmfhocal
...
\subsubsection*{attention head: ceann airde}
ainmfhocal

 \noindent \textit{Sainmhíniú (ga):} I gcomhthéacs trasfhoirmeora (nó modúl airde eile), foinse ionchuir amháin don modúl airde.
\\
 \noindent \textit{Sainmhíniú (en):} In the context of a transformer (or other attention block), one input source to the attention block.
\\
 \noindent \textit{Tagairtí:}
\begin{itemize}
...
\subsubsection*{attention layer: ciseal airde}
ainmfhocal
...
\subsubsection*{attention mechanism: oibriú airde}
ainmfhocal
...
\begin{itemize}
	...
	\item Féach chomh maith ar an téarma `attention / aird'.
	\item Féach chomh maith ar an téarma `attention layer / ciseal aird'.
\end{itemize}
...
\subsubsection*{baseline model: samhail bhunlíne}
ainmfhocal
...
\subsubsection*{batch size: méid na mbaisceanna}
ainmfhocal
...
\subsubsection*{benchmark dataset: tacar sonraí comparáide}
ainmfhocal
...
\subsubsection*{binary cross entropy loss (BCEL): pionós tras-eantrópachta dénártha (PTED)}
ainmfhocal
...
\subsubsection*{to bound: cuimsigh}
briathar
...
\subsubsection*{classification: aicmiú}
ainmfhocal
...
\subsubsection*{classifier: aicmitheoir}
ainmfhocal
...
\end{itemize}
 ...
 \noindent \textit{Nótaí Aistriúcháin:}
\begin{itemize}
	\item Níl iontráil ar leith ag an iarmhír `-eoir' sna foclóirí thuas, ach luann siad uilig go leor focal a úsáideann an iarmhír seo díreach mar a úsáidtear anseo.
\end{itemize}


\subsubsection*{to classify: aicmigh}
ainmfhocal
...
\subsubsection*{Closed World Assumption: Foshuíomh an Domhain Dhúnta}
ainmfhocal
...
\subsubsection*{cluster: braisle (pointí)}
ainmfhocal
...
\subsubsection*{to cluster: aicmiú ionduchtach a dhéanamh}
briathar
...
\subsubsection*{clustering: aicmiú ionduchtach}
ainmfhocal
...
\subsubsection*{co-frequency: cóimhinicíocht}
ainmfhocal
...
\subsubsection*{coefficient: comhéifeacht}
ainmfhocal
...
\subsubsection*{computer network: líonra ríomhairí}
ainmfhocal
...
\subsubsection*{computer science: ríomheolaíocht}
ainmfhocal
...
\subsubsection*{connectivity: (frása le `ceangailte')}
ainmfhocal
...
\subsubsection*{consequent: iarmhairt}
ainmfhocal
...
\subsubsection*{correct fitting: foghlaim cheart}
ainmfhocal
...
\subsubsection*{to correlate: comhghaolaigh}
briathar
...
\subsubsection*{correlation: comhghaol}
ainmfhocal
...
\subsubsection*{correlation coefficient: comhéifeacht comhghaolúcháin}
ainmfhocal
...
\subsubsection*{to corrupt: malartaigh}
briathar
...
\subsubsection*{counterexample: frith-shampla}
ainmfhocal
...
\subsubsection*{cross entropy loss (CEL): pionós tras-eantrópachta (PTE)}
ainmfhocal
...
\subsubsection*{cross-attention: tras-aird}
ainmfhocal
...
\subsubsection*{cross-entropy: tras-eantrópacht}
ainmfhocal
...
\subsubsection*{data leak: sceitheadh sonraí}
ainmfhocal
...
\subsubsection*{database: bunachar sonraí}
ainmfhocal
...
\subsubsection*{dataset: tacar sonraí}
ainmfhocal
...
\subsubsection*{decision boundary: teorainn chinnidh}
ainmfhocal
...
\\
 \noindent \textit{Tagairtí:}
\begin{itemize}
	\item teorainn: De Bhaldraithe (1978) \cite{de-bhaldraithe}, Dineen (1934) \cite{dineen}, Ó Dónaill et al. (1991) \cite{focloir-beag}, Ó Dónaill (1977) \cite{odonaill}, Williams et al. (2023) \cite{storchiste}
	\item cinneadh: De Bhaldraithe (1978) \cite{de-bhaldraithe}, Dineen (1934) \cite{dineen}, Ó Dónaill et al. (1991) \cite{focloir-beag}, Ó Dónaill (1977) \cite{odonaill}, Williams et al. (2023) \cite{storchiste}
\end{itemize}

 \noindent \textit{Nótaí Aistriúcháin:}
\begin{itemize}
	\item Is é `teora' seachas `teorainn' atá i bhFoclóir Uí Dhuinín.
	\item Ní luaitear ceachtar den dá théarma thuas i gcomhthéacs ríomhfhoghlama. Sin ráite, is fíos gur sórt teorainn í an teorainn chinnidh -- ach is teorainn idir dhá chinneadh, seachas idir dhá thír, atá i gceist. Glactar le `teorainn chinnidh' mar sin.
\end{itemize}


\subsubsection*{decision tree: crann cinnte}
ainmfhocal

 \noindent \textit{Sainmhíniú (ga):} I gcomhthéacs ríomheolaíochta, uirlis ríomhfhoghlama a dhéanann réamhinsintí (nó `cinntí') de réir rialacha atá samhlaithe ar craobhacha an chrainn.
\\
...
\begin{itemize}
	...
	\item Is é `crann cinnteoireachta' atá ar Téarma.ie. Sin ráite, ní fheictear cúis ar bith nach leor ceann cinnte (sin crann + cinneadh (ainmfhocal), seachas crann + cinnte (aidiacht)). Is éard is crann cinnte ann ná crann ríomheolaíochta a dhéanann cinntí -- mar sin, crann cinnte.
	\item Féach chomh maith ar an téarma `tree / crann'.
\end{itemize}


\subsubsection*{deep learning: foghlaim dhomhain}
ainmfhocal
...
\subsubsection*{dense layer: ciseal lán-cheangailte}
ainmfhocal
...
\subsubsection*{dependency graph: graf spleáchais}
ainmfhocal
...
\subsubsection*{DIKW Pyramid: Pirimid SFEE}
ainmfhocal
...
\subsubsection*{dimensionality: (frása le `toise')}
ainmfhocal
...
\subsubsection*{directed: dírithe}
aidiacht
...
\subsubsection*{distribution: dáileadh}
ainmfhocal
...
\subsubsection*{dropout layer: ciseal nialas}
ainmfhocal
...
\subsubsection*{efficiency: éifeachtacht (ama, fhuinnimh)}
ainmfhocal
...
\subsubsection*{to embed: leabaigh}
briathar
...
\subsubsection*{end condition: coinníoll críochnaithe}
ainmfhocal
...
\subsubsection*{entity alignment: ailíniú aonad}
ainmfhocal
...
\subsubsection*{entropy: eantrópacht}
ainmfhocal
...
\subsubsection*{environment: comhthéacs cóid}
ainmfhocal
...
\subsubsection*{equation: cothromóid}
ainmfhocal
...
\subsubsection*{estimate: meastachán}
ainmfhocal
...
\subsubsection*{to estimate (about): meastachán a dhéanamh (ar)}
ainmfhocal
...
\subsubsection*{to evaluate: measúnaigh}
briathar
...
\subsubsection*{evaluation: measúnú}
ainmfhocal
...
\subsubsection*{expression: slonn}
ainmfhocal
...
\subsubsection*{family: (frása le `gaolmhar')}
ainmfhocal
...
\subsubsection*{few-shot: cúpla-sonra}
aidiacht
...
\subsubsection*{filtering: scagaireacht}
ainmfhocal
...
\subsubsection*{to finetune: mion-fheabhsú}
briathar
...
\subsubsection*{foundation model: samhail fhorais}
ainmfhocal

 \noindent \textit{Sainmhíniú (ga):} I gcomhthéacs ríomheolaíochta, samhail ríomhfhoghlama ar féidir í a úsáid mar fhoras foghlama i réimse leathan, agus a mbíonn cur chuige tras-fhoghlama bunaithe uirthi chuige sin.
\\
 \noindent \textit{Sainmhíniú (en):} In the context of computer science, a machine learning model that can be used as the foundation of learning in a broad domain, and which is applied in the transfer learning setting to do so.
\\
 \noindent \textit{Tagairtí:}
\begin{itemize}
...
\end{itemize}
 ...
 \noindent \textit{Nótaí Aistriúcháin:}
\begin{itemize}
	\item Cé go bhfuil an focal `foras' i bhFoclóir De Bhaldraithe, is le brí ar leith atá sé luaite ann. Sna foclóirí eile, is leis am mbrí chéanna (i gcomhthéacs níos leithne) atá sé luaite.
	\item Féach chomh maith ar an téarma `model / samhail'.
\end{itemize}


\subsubsection*{framework: creatlach}
ainmfhocal
...
\subsubsection*{to freeze: buanaigh}
briathar
...
\subsubsection*{frequency: minicíocht}
ainmfhocal
...
\subsubsection*{generality: ginearáltacht}
ainmfhocal
...
\subsubsection*{generative: cumadóireachta}
aidiacht
...
\subsubsection*{genetic algorithm: algartam géiniteach}
ainmfhocal
...
\subsubsection*{global maximum: uasluach uilíoch}
ainmfhocal
...
\subsubsection*{global minimum: íosluach uilíoch}
ainmfhocal
...
\subsubsection*{graph foundation model: samhail fhorais ghraf}
ainmfhocal
...
\subsubsection*{graph neural network (GNN): líonra néarach graif (LNG)}
ainmfhocal
...
\subsubsection*{grid search: cuardach ar eangach}
ainmfhocal
...
\subsubsection*{ground truth: bun-fhírinneach}
aidiacht
...
\subsubsection*{ground truth (data): bun-fhírinne}
ainmfhocal
...
\subsubsection*{histogram: histeagram}
ainmfhocal
...
\subsubsection*{hits@k (H@k): fíricí@k (F@k)}
ainmfhocal
...
\subsubsection*{hyper-graph: hipear-ghraf}
ainmfhocal
...
\subsubsection*{hyperparameter: hipear-pharaiméadar}
ainmfhocal
...
\subsubsection*{hyperparameter combination: teaglaim hipear-pharaiméadar}
ainmfhocal
...
\subsubsection*{hyperparameter grid: eangach hipear-pharaiméadar}
ainmfhocal
...
\subsubsection*{hyperparameter search: cuardach hipear-pharaiméadar}
ainmfhocal
...
\subsubsection*{implementation: leagan infheidhmithe}
ainmfhocal
...
\subsubsection*{information content: lucht faisnéise}
ainmfhocal
...
\subsubsection*{to input (into): cuir isteach (i)}
ainmfhocal
...
\subsubsection*{to instantiate: cruthaigh}
briathar
...
\subsubsection*{instantiation (concept): leagan}
ainmfhocal
...
\subsubsection*{instantiation (object): réad}
ainmfhocal
...
\subsubsection*{instantiation (process): cruthú}
ainmfhocal
...
\subsubsection*{interface: comhéadan}
ainmfhocal
...
\subsubsection*{intersection: idirmhír}
ainmfhocal
...
\subsubsection*{interval: eatramh}
ainmfhocal
...
\subsubsection*{inverse: inbhéartach}
aidiacht
...
\subsubsection*{inverse (relation): inbhéarta}
ainmfhocal
...
\subsubsection*{knowledge graph (KG): graf eolais (GE)}
ainmfhocal
...
\subsubsection*{knowledge graph embedding (KGE): leabú graif eolais (LGE)}
ainmfhocal
...
\subsubsection*{knowledge graph embedding model (KGEM): samhail leabaithe graif eolais (SLGE)}
ainmfhocal
...
\subsubsection*{Kullback-Leibler (KL) divergence: dibhéirseacht Kullback-Leibler (KL)}
ainmfhocal
...
\subsubsection*{labelled: le lipéad}
aidiacht
...
\subsubsection*{language model (LM): samhail theanga (ST)}
ainmfhocal
...
\\
 \noindent \textit{Sainmhíniú (en):} In the context of computer science, a model that aims to understand and process natural human language.
\\
 \noindent \textit{Tagairtí:}
\begin{itemize}
	\item samhail: féach ar an téarma `model / samhail'
...
\subsubsection*{large language model (LLM): samhail theanga mhór (STM)}
ainmfhocal

 \noindent \textit{Sainmhíniú (ga):} I gcomhthéacs ríomhfhoghlama, samhail theanga a bhfuil na billiúin, na trilliúin, nó níos mó paraiméadar aici.
\\
...
\subsubsection*{learning rate: ráta foghlama}
ainmfhocal
...
\subsubsection*{library: leabharlann (chóid)}
ainmfhocal
...
\subsubsection*{link prediction (LP): réamhinsint nasc (RN)}
ainmfhocal
...
\subsubsection*{link prediction query: ceist réamhinsinte nasc}
ainmfhocal
...
\subsubsection*{link prediction task: tasc réamhinsinte nasc}
ainmfhocal
...
\subsubsection*{link predictor: réamhinsteoir nasc}
ainmfhocal
...
\subsubsection*{linked data (LD): sonraí nasctha (SN)}
ainmfhocal
...
\subsubsection*{linked open data (LOD): sonraí nasctha saor-rochtana (SNSR)}
ainmfhocal
...
\subsubsection*{local maximum: uasluach logánta}
ainmfhocal
...
\subsubsection*{local minimum: íosluach logánta}
ainmfhocal
...
\subsubsection*{loss: pionós (foghlama)}
ainmfhocal
...
\subsubsection*{loss function: feidhm phionóis}
ainmfhocal
...
\subsubsection*{machine learning: ríomhfhoghlaim}
ainmfhocal
...
\subsubsection*{margin ranking loss (MRL): pionós rangaithe le bearna (PRB)}
ainmfhocal
...
\subsubsection*{maximum: uasluach}
ainmfhocal
...
\subsubsection*{mean: meán- nó meánach}
aidiacht
...
\subsubsection*{mean (statistic): meán}
ainmfhocal
...
\subsubsection*{mean rank (MR): meán-rang (MR)}
ainmfhocal
...
\subsubsection*{mean reciprocal rank (MRR): meán na ranganna deilíneacha (MRD)}
ainmfhocal
...
\subsubsection*{mean squared error (MSE): meán na n-earráidí cearnaithe (MEC)}
ainmfhocal
...
\subsubsection*{to measure: tomhais}
ainmfhocal
...
\subsubsection*{median: airmheánach}
aidiacht
...
\subsubsection*{median (statistic): airmheán}
ainmfhocal
...
\subsubsection*{message passing: seachadadh teachtaireachtaí}
ainmfhocal
...
\subsubsection*{minimum: íosluach}
ainmfhocal
...
\subsubsection*{to model: samhlaigh}
ainmfhocal
...
\subsubsection*{modular: modúlach}
aidiacht
...
\subsubsection*{motif: móitíf}
ainmfhocal

 \noindent \textit{Sainmhíniú (ga):} I gcomhthéacs graif, patrún struchtúr (go háirithe ceann beag) a fheictear go minic i gcodanna ar leith den graf.
\\
...
\subsubsection*{multi-headed attention: aird il-cheannach}
ainmfhocal
...
\subsubsection*{negative (of number): diúltach}
aidiacht
...
\subsubsection*{negative (sample): frith-shampla}
ainmfhocal
...
\subsubsection*{negative sampler: frith-shamplóir}
ainmfhocal
...
\subsubsection*{negative sampling: frith-shampláil}
ainmfhocal
...
\subsubsection*{neighbour: comharsa}
ainmfhocal
...
\subsubsection*{neural network (NN): líonra néarach (LN)}
ainmfhocal
...
\subsubsection*{neuro-symbolic: néar-shiombalach}
aidiacht
...
\subsubsection*{non-linear: neamh-líneach}
aidiacht
...
\subsubsection*{object corruption: malartú an chuspóra}
ainmfhocal
...
\subsubsection*{object prediction: réamhinsint an chuspóra}
ainmfhocal
...
\subsubsection*{one-hot encoding: códú aon-innéacs}
ainmfhocal
...
\subsubsection*{ontology: ointeolaíocht}
ainmfhocal
...
\subsubsection*{open source: saor-rochtana}
aidiacht
...
\subsubsection*{Open World Assumption: Foshuíomh an Domhain Oscailte}
ainmfhocal
...
\subsubsection*{operation: oibriú}
ainmfhocal
...
\subsubsection*{operator: oibreoir}
ainmfhocal
...
\subsubsection*{optimisation: feabhsúchán}
ainmfhocal
...
\subsubsection*{to optimise: feabhsaigh}
briathar
...
\subsubsection*{optimiser: córas feabhsúcháin}
ainmfhocal
...
\subsubsection*{outlier: asluiteach}
ainmfhocal
...
\subsubsection*{to output: cuir amach}
ainmfhocal
...
\subsubsection*{overfitting: ró-fhoghlaim}
ainmfhocal
...
\subsubsection*{pairwise function: feidhm de phéire (pointí)}
ainmfhocal
...
\subsubsection*{parameter: paraiméadar}
ainmfhocal
...
\subsubsection*{percentile: peircintíl}
ainmfhocal
...
\subsubsection*{performance: éifeachtacht (ama, taisc)}
ainmfhocal
...
\subsubsection*{plausibility: inchreidteacht}
ainmfhocal
...
\subsubsection*{plausibility score: scór inchreidteachta}
ainmfhocal
...
\subsubsection*{pointwise function: feidhm de phointe}
ainmfhocal
...
\subsubsection*{positive (of number): deimhneach}
aidiacht
...
\subsubsection*{positive (triple): fíor-abairt (thriarach)}
ainmfhocal
...
\subsubsection*{predicate: faisnéis}
ainmfhocal
...
\subsubsection*{to predict: réamhinis}
briathar
...
\subsubsection*{prediction: réamhinsint}
ainmfhocal
...
\subsubsection*{predictor: réamhinsteoir}
ainmfhocal
...
\subsubsection*{to pretrain: réamh-thraenáil}
briathair
...
\subsubsection*{pretraining: réamh-thraenáil}
ainmfhocal
...
\subsubsection*{probability: dóchúlacht}
ainmfhocal
...
\subsubsection*{proportion: comhréir}
ainmfhocal
...
\subsubsection*{pseudotype: aicme chumtha}
ainmfhocal
...
\subsubsection*{pseudotyped: le haicme chumtha}
aidiacht
...
\subsubsection*{qualitative: cineálach}
aidiacht
...
\subsubsection*{to quantify: cainníochtaigh}
briathar
...
\subsubsection*{quantitative: cainníochtúil}
aidiacht
...
\subsubsection*{random: randamach}
aidiacht
...
\subsubsection*{random number generator: gineadóir uimhreacha randamacha}
ainmfhocal
...
\subsubsection*{random sample: sampla fánach}
ainmfhocal
...
\subsubsection*{random search: cuardach randamach}
ainmfhocal
...
\subsubsection*{random seed: fréamh randamach}
ainmfhocal
...
\subsubsection*{random walk: siúlóid fhánach}
aidiacht
...
\subsubsection*{to rank: rangaigh}
briathar
...
\subsubsection*{ranked list: liosta ranganna}
ainmfhocal
...
\subsubsection*{to reason (on): réasúnaíocht a dhéanamh (ar)}
briathar
...
\subsubsection*{reasoner: córas réasúnaíochta}
ainmfhocal
...
\subsubsection*{reasoning: réasúnaíocht}
ainmfhocal
...
\subsubsection*{reference implementation: leagan infheidhmithe caighdeánach}
ainmfhocal
...
\subsubsection*{to regress: cúlaigh}
briathar
...
\subsubsection*{regressor: cúlaitheoir}
ainmfhocal
...
\subsubsection*{regularisation: tabhairt chun rialtachta}
ainmfhocal
...
\subsubsection*{to regularise: tabhair chun rialtachta}
briathar
...
\subsubsection*{regulariser: córas rialtachta}
ainmfhocal
...
\end{itemize}
 ...
 \noindent \textit{Nótaí Aistriúcháin:}
\begin{itemize}
	\item Níl an téarma seo le fáil go díreach i bhfoclóir dúchasach ar bith. Rinneadh an rogha `tearcú' a úsáid toisc gurb é an focal is giorra don bhrí atá de dhíth, agus toisc go n-éiríonn graf níos teirce tar éis do a bheith `reified'.
\end{itemize}


\subsubsection*{to reify: tearcaigh}
briathar

 \noindent \textit{Sainmhíniú (ga):} I gcomhthéacs graf, an próiseas tearcaithe a chur i gcrích.
\\
 \noindent \textit{Sainmhíniú (en):} In the context of graphs, to perform the reification process.
\\
 \noindent \textit{Tagairtí:}
\begin{itemize}
...
\subsubsection*{relation(ship): ceangal}
ainmfhocal
...
\subsubsection*{relative entropy: eantrópacht choibhneasta}
ainmfhocal
...
\subsubsection*{repository: stór (cóid)}
ainmfhocal

 \noindent \textit{Sainmhíniú (ga):} I gcomhthéacs ríomheolaíochta, suíomh ar líne (.i. GitHub) nó fillteán logánta ar ríomhaire (.i. fillteán .git/) a bhfuil cód, agus stair na sean-leaganacha de, stóráilte.
\\
...
\begin{itemize}
	...
	\item Is focal an-choitianta sa nGaeilge é `stór', nach ionann agus `repository' (nach mbíonn úsáidte i mBéarla ach chun trácht a dhéanamh ar stór cóid). Mar sin, muna bhfuil an comhthéacs soiléir, moltar `stór cóid' a úsáid chun an bhrí atá i gceist anseo a shainmhíniú ar an gcéad úsáid.
	\item Féach chomh maith ar an téarma `source code / (bun-)chód'.
\end{itemize}


\subsubsection*{representation: leagan}
ainmfhocal
...
\subsubsection*{representative: ionadaíochta}
aidiacht
...
\subsubsection*{reproducible: in-athdhéanta}
aidiacht
...
\subsubsection*{rule (in logic): riail (loighce)}
ainmfhocal
...
\subsubsection*{rule-based: bunaithe ar rialacha}
aidiacht
...
\subsubsection*{to run: cuir ar siúl}
briathar
...
\subsubsection*{to sample: sampláil}
briathar
...
\subsubsection*{sampler: samplóir}
ainmfhocal
...
\subsubsection*{scatter plot (or diagram): scaipléaráid}
ainmfhocal
...
\subsubsection*{to score: scóráil}
briathar
...
\subsubsection*{scoring function: feidhm scórála}
ainmfhocal
...
\subsubsection*{self-attention: féin-aird}
ainmfhocal
...
\subsubsection*{self-supervised: faoi fhéin-mhaoirseacht}
aidiacht
...
\subsubsection*{semantics: séimeantaic}
ainmfhocal
...
\subsubsection*{semi-supervised: faoi leath-mhaoirseacht}
aidiacht
...
\subsubsection*{setwise function: feidhm de thacar (pointí)}
ainmfhocal
...
\subsubsection*{sigmoid function: feidhm shiogmóideach}
aidiacht
...
\subsubsection*{signal: comhartha}
ainmfhocal
...
\subsubsection*{to simulate: insamhail}
briathar
...
\subsubsection*{simulation: insamhladh}
ainmfhocal
...
\subsubsection*{social network: líonra cairdis}
ainmfhocal
...
\subsubsection*{source code: (bun-)chód}
ainmfhocal
...
\subsubsection*{standard deviation: diall caighdeánach}
ainmfhocal
...
\subsubsection*{state of the art (best): scoth an réimse}
ainmfhocal
...
\subsubsection*{state of the art (current): staid an réimse}
ainmfhocal
...
\subsubsection*{state of the art (the literature): litríocht an réimse}
ainmfhocal
...
\subsubsection*{structural alignment: ailíniú struchtúir}
ainmfhocal
...
\subsubsection*{structural alignment framework: creatlach ailínithe struchtúir}
ainmfhocal
...
\subsubsection*{structural alignment hypothesis: hipitéis ar ailíniú struchtúir}
ainmfhocal
...
\subsubsection*{structure: struchtúr}
ainmfhocal
...
\subsubsection*{subgraph: fo-ghraf}
ainmfhocal
...
\subsubsection*{subject corruption: malartú an ainmní}
ainmfhocal
...
\subsubsection*{subject prediction: réamhinsint an ainmní}
ainmfhocal
...
\subsubsection*{subset: fo-thacar}
ainmfhocal
...
\subsubsection*{supervised: faoi mhaoirseacht}
aidiacht
...
\subsubsection*{supervision: maoirseacht}
aidiacht
...
\subsubsection*{support vector: veicteoir tacaíochta}
ainmfhocal
...
\end{itemize}
 ...
 \noindent \textit{Nótaí Aistriúcháin:}
\begin{itemize}
	\item Tá an iliomad focal ar féidir iad a úsáid chun `support' a chur in iúl. Níl an focal `support' ina théarma sainmhínithe anseo. An t-aon bhrí atá i gceist ná gur féidir `support vectors' a úsáid chun tacú leis an próiseas foghlama.
	\item Féach chomh maith ar an téarma `vector / veicteoir'.
\end{itemize}


\subsubsection*{support vector classifier: aicmitheoir bunaithe ar veicteoirí tacaíochta}
ainmfhocal

 \noindent \textit{Sainmhíniú (ga):} Samhail veicteoirí tacaíochta a úsáidtear chun aicmiú a chur i gcrích.
\\
...
\subsubsection*{support vector machine (SVM): samhail (bunaithe ar) veicteoirí tacaíochta (SVT)}
ainmfhocal

 \noindent \textit{Sainmhíniú (ga):} Grúpa samhlacha ríomhfhoghlama atá bunaithe ar úsáid veicteoirí tacaíochta chun éifeachtach ríomhfhoghlama a chur chun cinn.
\\
 \noindent \textit{Sainmhíniú (en):} A family of machine learning models that are based on the use of support vectors to improve machine learning performance.
\\
 \noindent \textit{Tagairtí:}
\begin{itemize}
	\item samhail: féach ar an téarma `model / samhail'
...
\begin{itemize}
	...
	\item Is minic agus an téarma seo úsáidte san uimhir iolra (.i. `support vector machines'). Is é an leagan iolra ceart ná `samhlacha veicteoirí tacaíochta'.
...
\subsubsection*{support vector regressor: cúlaitheoir bunaithe ar veicteoirí tacaíochta}
ainmfhocal

 \noindent \textit{Sainmhíniú (ga):} Samhail veicteoirí tacaíochta a úsáidtear chun cúlú a chur i gcrích.
\\
...
\subsubsection*{symbolic: siombalach}
aidiacht
...
\subsubsection*{symbolic logic: loighic shiombalach}
ainmfhocal
...
\subsubsection*{symmetric: siméadrach}
aidiacht
...
\subsubsection*{symmetry: siméadracht}
ainmfhocal
...
\subsubsection*{to test: teisteáil}
briathar
...
\subsubsection*{testing: teisteáil}
ainmfhocal
...
\subsubsection*{testing set: tacar teisteála}
ainmfhocal
...
\subsubsection*{topology: toipeolaíocht}
ainmfhocal
...
\subsubsection*{to train: traenáil}
briathar
...
\subsubsection*{training: traenáil}
ainmfhocal
...
\subsubsection*{training loop: timthriall traenála}
ainmfhocal
...
\subsubsection*{training set: tacar traenála}
ainmfhocal
...
\subsubsection*{transfer learning: tras-fhoghlaim}
ainmfhocal
...
\subsubsection*{transform: trasfhoirm}
ainmfhocal
...
\subsubsection*{to transform: trasfhoirmigh}
briathar
...
\subsubsection*{transformation: trasfhoirmiú}
ainmfhocal
...
\subsubsection*{transformer: trasfhoirmeoir}
ainmfhocal

 \noindent \textit{Sainmhíniú (ga):} I gcomhthéacs ríomhfhoghlama, modúl néarach a úsáideann sraith chisil airde le chéile.
\\
 \noindent \textit{Sainmhíniú (en):} In the context of machine learning, a neural module that uses layered attention layers.
\\
 \noindent \textit{Tagairtí:}
\begin{itemize}
...
\begin{itemize}
	...
	\item Níl iontráil ar leith den iarmhír `-eoir' sna foclóirí thuas, ach luann siad uilig go leor focal a úsáideann é díreach mar a úsáidtear anseo.
	\item Féach chomh maith ar an téarma `to transform / trasfhoirmigh'.
\end{itemize}


\subsubsection*{transitive: aistreach}
aidiacht
...
\subsubsection*{triple: abairt thriarach}
ainmfhocal
...
\subsubsection*{underfitting: foghlaim easnamhach}
ainmfhocal
...
\subsubsection*{unseen: gan feiceáil}
aidiacht
...
\subsubsection*{unsupervised: gan mhaoirseacht}
aidiacht
...
\subsubsection*{to validate: deimhnigh}
ainmfhocal
...
\subsubsection*{validation: deimhniú}
ainmfhocal
...
\subsubsection*{validation set: tacar deimhnithe}
ainmfhocal
...
\subsubsection*{variance: athraitheas}
ainmfhocal
...
\subsubsection*{vector: veicteoir}
ainmfhocal
...
\subsubsection*{to weight: ualaigh}
briathar
...
\subsubsection*{weighted: ualaithe}
aidiacht
...
\subsubsection*{weighted random search: cuardach randamach ualaithe}
ainmfhocal
