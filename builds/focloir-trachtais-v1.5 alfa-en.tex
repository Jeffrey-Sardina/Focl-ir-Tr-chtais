...
\subsection*{0-shot (aidiacht): 0-sonra} \addcontentsline{toc}{subsection}{0-shot (aidiacht): 0-sonra}
...
\subsection*{ablation experiment (ainmfhocal): turgnamh ionadaithe} \addcontentsline{toc}{subsection}{ablation experiment (ainmfhocal): turgnamh ionadaithe}
...
\subsection*{to abstract (ainmfhocal): teibigh} \addcontentsline{toc}{subsection}{to abstract (ainmfhocal): teibigh}
...
\subsection*{abstraction (ainmfhocal): teibiú} \addcontentsline{toc}{subsection}{abstraction (ainmfhocal): teibiú}
...
\subsection*{activation function (ainmfhocal): feidhm ghníomhachtaithe} \addcontentsline{toc}{subsection}{activation function (ainmfhocal): feidhm ghníomhachtaithe}
...
\subsection*{adjacency matrix (ainmfhocal): maitrís chóngarachta} \addcontentsline{toc}{subsection}{adjacency matrix (ainmfhocal): maitrís chóngarachta}
...
\subsection*{aggregate (ainmfhocal): tionól} \addcontentsline{toc}{subsection}{aggregate (ainmfhocal): tionól}
...
\subsection*{algorithm (ainmfhocal): algartam} \addcontentsline{toc}{subsection}{algorithm (ainmfhocal): algartam}
...
\subsection*{application (in practice) (ainmfhocal): úsáid (phraiticiúil)} \addcontentsline{toc}{subsection}{application (in practice) (ainmfhocal): úsáid (phraiticiúil)}
...
\subsection*{arbitrary (aidiacht): treallach} \addcontentsline{toc}{subsection}{arbitrary (aidiacht): treallach}
...
\subsection*{atomic (aidiacht): adamhach} \addcontentsline{toc}{subsection}{atomic (aidiacht): adamhach}
...
\subsection*{baseline model (ainmfhocal): samhail bhunlíne} \addcontentsline{toc}{subsection}{baseline model (ainmfhocal): samhail bhunlíne}
...
\subsection*{batch (ainmfhocal): baisc} \addcontentsline{toc}{subsection}{batch (ainmfhocal): baisc}
...
\subsection*{batch size (ainmfhocal): méid na mbaisceanna} \addcontentsline{toc}{subsection}{batch size (ainmfhocal): méid na mbaisceanna}
...
\subsection*{Bayesian (aidiacht): Bayes} \addcontentsline{toc}{subsection}{Bayesian (aidiacht): Bayes}
...
\subsection*{bin (ainmfhocal): eatramh} \addcontentsline{toc}{subsection}{bin (ainmfhocal): eatramh}
...
\subsection*{binary (aidiacht): dénártha} \addcontentsline{toc}{subsection}{binary (aidiacht): dénártha}
...
\subsection*{binary cross entropy loss (BCEL) (ainmfhocal): pionós tras-eantrópachta dénártha (PTED)} \addcontentsline{toc}{subsection}{binary cross entropy loss (BCEL) (ainmfhocal): pionós tras-eantrópachta dénártha (PTED)}
...
\subsection*{to bound (briathar): cuimsigh} \addcontentsline{toc}{subsection}{to bound (briathar): cuimsigh}
...
\subsection*{Closed World Assumption (ainmfhocal): Foshuíomh an Domhain Dhúnta} \addcontentsline{toc}{subsection}{Closed World Assumption (ainmfhocal): Foshuíomh an Domhain Dhúnta}
...
\subsection*{to cluster (briathar): aicmiú ionduchtach a dhéanamh} \addcontentsline{toc}{subsection}{to cluster (briathar): aicmiú ionduchtach a dhéanamh}
...
\subsection*{clustering (ainmfhocal): aicmiú ionduchtach} \addcontentsline{toc}{subsection}{clustering (ainmfhocal): aicmiú ionduchtach}
...
\subsection*{constant (aidiacht): buan-} \addcontentsline{toc}{subsection}{constant (aidiacht): buan-}
...
\subsection*{to correlate (briathar): comhghaolaigh} \addcontentsline{toc}{subsection}{to correlate (briathar): comhghaolaigh}
...
\subsection*{correlation (ainmfhocal): comhghaol} \addcontentsline{toc}{subsection}{correlation (ainmfhocal): comhghaol}
...
\subsection*{correlation coefficient (ainmfhocal): comhéifeacht comhghaolúcháin} \addcontentsline{toc}{subsection}{correlation coefficient (ainmfhocal): comhéifeacht comhghaolúcháin}
...
\subsection*{cross entropy loss (CEL) (ainmfhocal): pionós tras-eantrópachta (PTE)} \addcontentsline{toc}{subsection}{cross entropy loss (CEL) (ainmfhocal): pionós tras-eantrópachta (PTE)}
...
\subsection*{cross-entropy (ainmfhocal): tras-eantrópacht} \addcontentsline{toc}{subsection}{cross-entropy (ainmfhocal): tras-eantrópacht}
...
\subsection*{curve (ainmfhocal): cuar} \addcontentsline{toc}{subsection}{curve (ainmfhocal): cuar}
...
\subsection*{data leak (ainmfhocal): sceitheadh sonraí} \addcontentsline{toc}{subsection}{data leak (ainmfhocal): sceitheadh sonraí}
...
\subsection*{deep learning (ainmfhocal): foghlaim dhomhain} \addcontentsline{toc}{subsection}{deep learning (ainmfhocal): foghlaim dhomhain}
...
\subsection*{density (ainmfhocal): dlús} \addcontentsline{toc}{subsection}{density (ainmfhocal): dlús}
...
\subsection*{dependency graph (ainmfhocal): graf spleáchais} \addcontentsline{toc}{subsection}{dependency graph (ainmfhocal): graf spleáchais}
...
\subsection*{DIKW Pyramid (ainmfhocal): Pirimid SFEE} \addcontentsline{toc}{subsection}{DIKW Pyramid (ainmfhocal): Pirimid SFEE}
...
\subsection*{element (ainmfhocal): ball} \addcontentsline{toc}{subsection}{element (ainmfhocal): ball}
...
\subsection*{end condition (ainmfhocal): coinníoll críochnaithe} \addcontentsline{toc}{subsection}{end condition (ainmfhocal): coinníoll críochnaithe}
...
\subsection*{entropy (ainmfhocal): eantrópacht} \addcontentsline{toc}{subsection}{entropy (ainmfhocal): eantrópacht}
...
\subsection*{error (ainmfhocal): earráid} \addcontentsline{toc}{subsection}{error (ainmfhocal): earráid}
...
\subsection*{family (ainmfhocal): (frása le `gaolmhar')} \addcontentsline{toc}{subsection}{family (ainmfhocal): (frása le `gaolmhar')}
...
\subsection*{few-shot (aidiacht): cúpla-sonra} \addcontentsline{toc}{subsection}{few-shot (aidiacht): cúpla-sonra}
...
\subsection*{filter (ainmfhocal): scagaire} \addcontentsline{toc}{subsection}{filter (ainmfhocal): scagaire}
...
\subsection*{to filter (briathar): scag} \addcontentsline{toc}{subsection}{to filter (briathar): scag}
...
\subsection*{filtering (ainmfhocal): scagaireacht} \addcontentsline{toc}{subsection}{filtering (ainmfhocal): scagaireacht}
...
\subsection*{to freeze (briathar): buanaigh} \addcontentsline{toc}{subsection}{to freeze (briathar): buanaigh}
...
\subsection*{generality (ainmfhocal): ginearáltacht} \addcontentsline{toc}{subsection}{generality (ainmfhocal): ginearáltacht}
...
\subsection*{genetic algorithm (ainmfhocal): algartam géiniteach} \addcontentsline{toc}{subsection}{genetic algorithm (ainmfhocal): algartam géiniteach}
...
\subsection*{graph neural network (GNN) (ainmfhocal): líonra néarach graif (LNG)} \addcontentsline{toc}{subsection}{graph neural network (GNN) (ainmfhocal): líonra néarach graif (LNG)}
...
\subsection*{grid search (ainmfhocal): cuardach ar eangach} \addcontentsline{toc}{subsection}{grid search (ainmfhocal): cuardach ar eangach}
...
\subsection*{ground truth (aidiacht): bun-fhírinneach} \addcontentsline{toc}{subsection}{ground truth (aidiacht): bun-fhírinneach}
...
\subsection*{ground truth (data) (ainmfhocal): bun-fhírinne} \addcontentsline{toc}{subsection}{ground truth (data) (ainmfhocal): bun-fhírinne}
...
\subsection*{hits@k (H@k) (ainmfhocal): fíricí@k (F@k)} \addcontentsline{toc}{subsection}{hits@k (H@k) (ainmfhocal): fíricí@k (F@k)}
...
\subsection*{hop (ainmfhocal): coiscéim} \addcontentsline{toc}{subsection}{hop (ainmfhocal): coiscéim}
...
\subsection*{hyperparameter combination (ainmfhocal): teaglaim hipear-pharaiméadar} \addcontentsline{toc}{subsection}{hyperparameter combination (ainmfhocal): teaglaim hipear-pharaiméadar}
...
\subsection*{hyperparameter grid (ainmfhocal): eangach hipear-pharaiméadar} \addcontentsline{toc}{subsection}{hyperparameter grid (ainmfhocal): eangach hipear-pharaiméadar}
...
\subsection*{information content (ainmfhocal): lucht faisnéise} \addcontentsline{toc}{subsection}{information content (ainmfhocal): lucht faisnéise}
...
\subsection*{interface (ainmfhocal): comhéadan} \addcontentsline{toc}{subsection}{interface (ainmfhocal): comhéadan}
...
\subsection*{intersection (ainmfhocal): idirmhír} \addcontentsline{toc}{subsection}{intersection (ainmfhocal): idirmhír}
...
\subsection*{interval (ainmfhocal): eatramh} \addcontentsline{toc}{subsection}{interval (ainmfhocal): eatramh}
...
\subsection*{Kullback-Leibler (KL) divergence (ainmfhocal): dibhéirseacht Kullback-Leibler (KL)} \addcontentsline{toc}{subsection}{Kullback-Leibler (KL) divergence (ainmfhocal): dibhéirseacht Kullback-Leibler (KL)}
...
\subsection*{linear (aidiacht): líneach} \addcontentsline{toc}{subsection}{linear (aidiacht): líneach}
...
\subsection*{linked open data (LOD) (ainmfhocal): sonraí nasctha saor-rochtana (SNSR)} \addcontentsline{toc}{subsection}{linked open data (LOD) (ainmfhocal): sonraí nasctha saor-rochtana (SNSR)}
...
\subsection*{logic (ainmfhocal): loighic} \addcontentsline{toc}{subsection}{logic (ainmfhocal): loighic}
...
\subsection*{machine (aidiacht): ríomh-} \addcontentsline{toc}{subsection}{machine (aidiacht): ríomh-}
...
\subsection*{to map (briathar): mapáil} \addcontentsline{toc}{subsection}{to map (briathar): mapáil}
...
\subsection*{margin (ainmfhocal): bearna} \addcontentsline{toc}{subsection}{margin (ainmfhocal): bearna}
...
\subsection*{margin ranking loss (MRL) (ainmfhocal): pionós rangaithe le bearna (PRB)} \addcontentsline{toc}{subsection}{margin ranking loss (MRL) (ainmfhocal): pionós rangaithe le bearna (PRB)}
...
\subsection*{matrix (ainmfhocal): maitrís} \addcontentsline{toc}{subsection}{matrix (ainmfhocal): maitrís}
...
\subsection*{maximum (ainmfhocal): uasluach} \addcontentsline{toc}{subsection}{maximum (ainmfhocal): uasluach}
...
\subsection*{mean (aidiacht): meán- nó meánach} \addcontentsline{toc}{subsection}{mean (aidiacht): meán- nó meánach}
...
\subsection*{mean (statistic) (ainmfhocal): meán} \addcontentsline{toc}{subsection}{mean (statistic) (ainmfhocal): meán}
...
\subsection*{mean rank (MR) (ainmfhocal): meán-rang (MR)} \addcontentsline{toc}{subsection}{mean rank (MR) (ainmfhocal): meán-rang (MR)}
...
\subsection*{mean reciprocal rank (MRR) (ainmfhocal): meán na ranganna deilíneacha (MRD)} \addcontentsline{toc}{subsection}{mean reciprocal rank (MRR) (ainmfhocal): meán na ranganna deilíneacha (MRD)}
...
\subsection*{mean squared error (MSE) (ainmfhocal): meán na n-earráidí cearnaithe (MEC)} \addcontentsline{toc}{subsection}{mean squared error (MSE) (ainmfhocal): meán na n-earráidí cearnaithe (MEC)}
...
\subsection*{median (aidiacht): airmheánach} \addcontentsline{toc}{subsection}{median (aidiacht): airmheánach}
...
\subsection*{median (statistic) (ainmfhocal): airmheán} \addcontentsline{toc}{subsection}{median (statistic) (ainmfhocal): airmheán}
...
\subsection*{message passing (ainmfhocal): seachadadh teachtaireachtaí} \addcontentsline{toc}{subsection}{message passing (ainmfhocal): seachadadh teachtaireachtaí}
...
\subsection*{n-shot (aidiacht): n-sonra} \addcontentsline{toc}{subsection}{n-shot (aidiacht): n-sonra}
...
\subsection*{negative (of number) (aidiacht): diúltach} \addcontentsline{toc}{subsection}{negative (of number) (aidiacht): diúltach}
...
\subsection*{negative sampling (ainmfhocal): frith-shampláil} \addcontentsline{toc}{subsection}{negative sampling (ainmfhocal): frith-shampláil}
...
\subsection*{neighbour (ainmfhocal): comharsa} \addcontentsline{toc}{subsection}{neighbour (ainmfhocal): comharsa}
...
\subsection*{neuro-symbolic (aidiacht): néar-shiombalach} \addcontentsline{toc}{subsection}{neuro-symbolic (aidiacht): néar-shiombalach}
...
\subsection*{non-linear (aidiacht): neamh-líneach} \addcontentsline{toc}{subsection}{non-linear (aidiacht): neamh-líneach}
...
\subsection*{one-hot encoding (ainmfhocal): códú aon-innéacs} \addcontentsline{toc}{subsection}{one-hot encoding (ainmfhocal): códú aon-innéacs}
...
\subsection*{open source (aidiacht): saor-rochtana} \addcontentsline{toc}{subsection}{open source (aidiacht): saor-rochtana}
...
\subsection*{Open World Assumption (ainmfhocal): Foshuíomh an Domhain Oscailte} \addcontentsline{toc}{subsection}{Open World Assumption (ainmfhocal): Foshuíomh an Domhain Oscailte}
...
\subsection*{operation (ainmfhocal): oibriú} \addcontentsline{toc}{subsection}{operation (ainmfhocal): oibriú}
...
\subsection*{operator (ainmfhocal): oibreoir} \addcontentsline{toc}{subsection}{operator (ainmfhocal): oibreoir}
...
\subsection*{outlier (ainmfhocal): asluiteach} \addcontentsline{toc}{subsection}{outlier (ainmfhocal): asluiteach}
...
\subsection*{pairwise function (ainmfhocal): feidhm de phéire (pointí)} \addcontentsline{toc}{subsection}{pairwise function (ainmfhocal): feidhm de phéire (pointí)}
...
\subsection*{percentile (ainmfhocal): peircintíl} \addcontentsline{toc}{subsection}{percentile (ainmfhocal): peircintíl}
...
\subsection*{pointwise function (ainmfhocal): feidhm de phointe} \addcontentsline{toc}{subsection}{pointwise function (ainmfhocal): feidhm de phointe}
...
\subsection*{positive (of number) (aidiacht): deimhneach} \addcontentsline{toc}{subsection}{positive (of number) (aidiacht): deimhneach}
...
\subsection*{to predict (briathar): réamhinis} \addcontentsline{toc}{subsection}{to predict (briathar): réamhinis}
...
\subsection*{prediction (ainmfhocal): réamhinsint} \addcontentsline{toc}{subsection}{prediction (ainmfhocal): réamhinsint}
...
\subsection*{predictor (ainmfhocal): réamhinsteoir} \addcontentsline{toc}{subsection}{predictor (ainmfhocal): réamhinsteoir}
...
\subsection*{proportion (ainmfhocal): comhréir} \addcontentsline{toc}{subsection}{proportion (ainmfhocal): comhréir}
...
\subsection*{pseudotype (ainmfhocal): aicme chumtha} \addcontentsline{toc}{subsection}{pseudotype (ainmfhocal): aicme chumtha}
...
\subsection*{pseudotyped (aidiacht): le haicme chumtha} \addcontentsline{toc}{subsection}{pseudotyped (aidiacht): le haicme chumtha}
...
\subsection*{to quantify (briathar): cainníochtaigh} \addcontentsline{toc}{subsection}{to quantify (briathar): cainníochtaigh}
...
\subsection*{random number generator (ainmfhocal): gineadóir uimhreacha randamacha} \addcontentsline{toc}{subsection}{random number generator (ainmfhocal): gineadóir uimhreacha randamacha}
...
\subsection*{random search (ainmfhocal): cuardach randamach} \addcontentsline{toc}{subsection}{random search (ainmfhocal): cuardach randamach}
...
\subsection*{random seed (ainmfhocal): fréamh randamach} \addcontentsline{toc}{subsection}{random seed (ainmfhocal): fréamh randamach}
...
\subsection*{random walk (aidiacht): siúlóid fhánach} \addcontentsline{toc}{subsection}{random walk (aidiacht): siúlóid fhánach}
...
\subsection*{rank (ainmfhocal): rang} \addcontentsline{toc}{subsection}{rank (ainmfhocal): rang}
...
\subsection*{to rank (briathar): rangaigh} \addcontentsline{toc}{subsection}{to rank (briathar): rangaigh}
...
\subsection*{ranked list (ainmfhocal): liosta ranganna} \addcontentsline{toc}{subsection}{ranked list (ainmfhocal): liosta ranganna}
...
\subsection*{ranking (ainmfhocal): rangú} \addcontentsline{toc}{subsection}{ranking (ainmfhocal): rangú}
...
\subsection*{ratio (ainmfhocal): cóimheas} \addcontentsline{toc}{subsection}{ratio (ainmfhocal): cóimheas}
...
\subsection*{reasoner (ainmfhocal): córas réasúnaíochta} \addcontentsline{toc}{subsection}{reasoner (ainmfhocal): córas réasúnaíochta}
...
\subsection*{reasoning (ainmfhocal): réasúnaíocht} \addcontentsline{toc}{subsection}{reasoning (ainmfhocal): réasúnaíocht}
...
\subsection*{region (ainmfhocal): réigiún} \addcontentsline{toc}{subsection}{region (ainmfhocal): réigiún}
...
\subsection*{relative entropy (ainmfhocal): eantrópacht choibhneasta} \addcontentsline{toc}{subsection}{relative entropy (ainmfhocal): eantrópacht choibhneasta}
...
\subsection*{reproducible (aidiacht): in-athdhéanta} \addcontentsline{toc}{subsection}{reproducible (aidiacht): in-athdhéanta}
...
\subsection*{rule (in logic) (ainmfhocal): riail (loighce)} \addcontentsline{toc}{subsection}{rule (in logic) (ainmfhocal): riail (loighce)}
...
\subsection*{rule-based (aidiacht): bunaithe ar rialacha} \addcontentsline{toc}{subsection}{rule-based (aidiacht): bunaithe ar rialacha}
...
\subsection*{scatter plot (or diagram) (ainmfhocal): scaipléaráid} \addcontentsline{toc}{subsection}{scatter plot (or diagram) (ainmfhocal): scaipléaráid}
...
\subsection*{self-supervised (aidiacht): faoi fhéin-mhaoirseacht} \addcontentsline{toc}{subsection}{self-supervised (aidiacht): faoi fhéin-mhaoirseacht}
...
\subsection*{semi-supervised (aidiacht): faoi leath-mhaoirseacht} \addcontentsline{toc}{subsection}{semi-supervised (aidiacht): faoi leath-mhaoirseacht}
...
\subsection*{setwise function (ainmfhocal): feidhm de thacar (pointí)} \addcontentsline{toc}{subsection}{setwise function (ainmfhocal): feidhm de thacar (pointí)}
...
\subsection*{sigmoid function (aidiacht): feidhm shiogmóideach} \addcontentsline{toc}{subsection}{sigmoid function (aidiacht): feidhm shiogmóideach}
...
\subsection*{source code (ainmfhocal): (bun-)chód} \addcontentsline{toc}{subsection}{source code (ainmfhocal): (bun-)chód}
...
\subsection*{sparsity (ainmfhocal): éadlús} \addcontentsline{toc}{subsection}{sparsity (ainmfhocal): éadlús}
...
\subsection*{standard deviation (ainmfhocal): diall caighdeánach} \addcontentsline{toc}{subsection}{standard deviation (ainmfhocal): diall caighdeánach}
...
\subsection*{state of the art (best) (ainmfhocal): scoth an réimse} \addcontentsline{toc}{subsection}{state of the art (best) (ainmfhocal): scoth an réimse}
...
\subsection*{state of the art (current) (ainmfhocal): staid an réimse} \addcontentsline{toc}{subsection}{state of the art (current) (ainmfhocal): staid an réimse}
...
\subsection*{state of the art (the literature) (ainmfhocal): litríocht an réimse} \addcontentsline{toc}{subsection}{state of the art (the literature) (ainmfhocal): litríocht an réimse}
...
\subsection*{subset (ainmfhocal): fo-thacar} \addcontentsline{toc}{subsection}{subset (ainmfhocal): fo-thacar}
...
\subsection*{supervised (aidiacht): faoi mhaoirseacht} \addcontentsline{toc}{subsection}{supervised (aidiacht): faoi mhaoirseacht}
...
\subsection*{supervision (aidiacht): maoirseacht} \addcontentsline{toc}{subsection}{supervision (aidiacht): maoirseacht}
...
\subsection*{symbol (ainmfhocal): siombail} \addcontentsline{toc}{subsection}{symbol (ainmfhocal): siombail}
...
\subsection*{symbolic (aidiacht): siombalach} \addcontentsline{toc}{subsection}{symbolic (aidiacht): siombalach}
...
\subsection*{symbolic logic (ainmfhocal): loighic shiombalach} \addcontentsline{toc}{subsection}{symbolic logic (ainmfhocal): loighic shiombalach}
...
\subsection*{training loop (ainmfhocal): timthriall traenála} \addcontentsline{toc}{subsection}{training loop (ainmfhocal): timthriall traenála}
...
\subsection*{to transform (briathar): trasfhoirmigh} \addcontentsline{toc}{subsection}{to transform (briathar): trasfhoirmigh}
...
\subsection*{transform (ainmfhocal): trasfhoirm} \addcontentsline{toc}{subsection}{transform (ainmfhocal): trasfhoirm}
...
\subsection*{transformation (ainmfhocal): trasfhoirmiú} \addcontentsline{toc}{subsection}{transformation (ainmfhocal): trasfhoirmiú}
...
\subsection*{transitive (aidiacht): aistreach} \addcontentsline{toc}{subsection}{transitive (aidiacht): aistreach}
...
\subsection*{union (ainmfhocal): aontas} \addcontentsline{toc}{subsection}{union (ainmfhocal): aontas}
...
\subsection*{unseen (aidiacht): gan feiceáil} \addcontentsline{toc}{subsection}{unseen (aidiacht): gan feiceáil}
...
\subsection*{unsupervised (aidiacht): gan mhaoirseacht} \addcontentsline{toc}{subsection}{unsupervised (aidiacht): gan mhaoirseacht}
...
\subsection*{variance (ainmfhocal): athraitheas} \addcontentsline{toc}{subsection}{variance (ainmfhocal): athraitheas}
...
\subsection*{walk (ainmfhocal): siúlóid} \addcontentsline{toc}{subsection}{walk (ainmfhocal): siúlóid}
...
\subsection*{weighted random search (ainmfhocal): cuardach randamach ualaithe} \addcontentsline{toc}{subsection}{weighted random search (ainmfhocal): cuardach randamach ualaithe}
...
\subsection*{z-score (ainmfhocal): scór-z} \addcontentsline{toc}{subsection}{z-score (ainmfhocal): scór-z}
